...
/**
* @property {number} width width of the generated SVG image
* @property {number} height height of the generated SVG image
* @property {number} points amount of points on the x axis
* @property {number} lines amount of lines that should be generated
* @property {GradientStop[]} colors SVG gradient over the x axis
*/
class Settings{
  ...
  class GradientStop{
    /**
    * @param {number} offset gradient offset
  ...
  */
   ...
   * @param {Settings} settings 
   * @param {number} n 
   * @returns {String[]} An array of generated SVG images as strings
   */
  function generateBatch(settings, n) {
    let r = [];
    if (n <= 0) return [];
    for (let x = 0; x < n; x++) {
      r.push(generate(settings));
    }
    return r;
  }
